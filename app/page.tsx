...
export default function Home() {
  return (
    <div className="min-h-screen bg-white font-sans text-gray-900">
      {/* Navigation */}
      <nav className="fixed top-0 w-full z-50 bg-white shadow-sm px-6 py-4">
        <div className="max-w-7xl mx-auto flex justify-between items-center">
          ...
          <button className="bg-pink-500 text-white px-7 py-3 rounded-full font-bold text-sm uppercase">
            Book Now
          </button>
        </div>
      </nav>
      ...
      <section className="relative min-h-screen flex items-center pt-20">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6">
          ...
          <button className="bg-white text-blue-900 px-10 py-5 rounded-full font-black uppercase tracking-widest hover:bg-pink-500 hover:text-white transition-all">
            Our Services
          </button>
        </div>
      </section>
